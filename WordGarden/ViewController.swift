...
//  WordGarden
//
//  Created by James Monahan on 9/14/20.
...
class ViewController: UIViewController {
    ...
    @IBOutlet weak var wordsRevealedLabel: UILabel!
    ...
    override func viewDidLoad() {
        ...
        wordsRevealedLabel.text = "_" + String(repeating: " _", count: wordToGuess.count-1)
    ...
    func formatRevealedWord(){
        ...
        wordsRevealedLabel.text = revealedWord
    }
    ...
    func guessALetter(){
        ...
        if wordsRevealedLabel.text!.contains("_") == false {
    ...
    @IBAction func doneKeyPressedUpon(_ sender: UITextField) {
        guessALetter()
        updateUIAfterGuess()
    }
